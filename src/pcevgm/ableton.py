...
STANDARD = (
    ...
    Envelope("stab", NONE, 300.0, SILENT, 20.0,
             "percussive, cut off the moment the key lifts"),
    Envelope("pluck", NONE, 300.0, -24.0, 30.0,
             "percussive, holding a trace of tone under the decay"),
    Envelope("decay", NONE, 5000.0, SILENT, 50.0,
             "a held piano key, ringing out past the longest decay measured"),
